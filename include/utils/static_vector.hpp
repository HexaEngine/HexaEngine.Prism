#ifndef HEXA_UTILS_STATIC_VECTOR_HPP
#define HEXA_UTILS_STATIC_VECTOR_HPP
...
namespace HEXA_UTILS_NAMESPACE
{
    ...
    class static_vector
    {
      ...
      public:
        static_vector(static_vector&& other) noexcept : alloc_m(std::move(other.alloc_m)), data_m(other.data_m), size_m(other.size_m)
        {
