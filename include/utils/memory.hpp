...
namespace HEXA_UTILS_NAMESPACE
{
    ...
    concept IsAllocatorDisabled = std::is_same_v<Alloc, Utils::DisabledAllocator<typename Alloc::value_type>>;
    ...
    class ObjPtr
    {
      ...
      public:
        ...
        ObjPtr<T> AddRef() const noexcept
        {
            if (ptr)
            {
                return ObjPtr<T>(ptr);
    ...
    class SharedObjectBase : public SharedObject
    {
      ...
      public:
        ...
        {
            auto ptr = reinterpret_cast<TDerived*>(Utils::aligned_alloc(alignof(TDerived), sizeof(TDerived)));
        ...
        {
            auto ptr = reinterpret_cast<TDerived*>(Utils::aligned_alloc(alignof(TDerived), sizeof(TDerived) + additionalSize));
            new (ptr) TDerived(std::forward<TArgs>(args)...);
            return ObjPtr<TDerived>(ptr);
        }
        ...
        {
            auto ptr = reinterpret_cast<U*>(Utils::aligned_alloc(alignof(U), sizeof(U)));
        ...
        {
            auto ptr = reinterpret_cast<U*>(Utils::aligned_alloc(alignof(U), sizeof(U) + additionalSize));
            new (ptr) U(std::forward<TArgs>(args)...);
            return ObjPtr<TDerived>(ptr);
        }
    };
