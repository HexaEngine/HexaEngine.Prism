...
static inline Utils::RangeIndex operator""_r(unsigned long long value)
{
    return Utils::RangeIndex(static_cast<size_t>(value), false);
}

static inline Utils::RangeIndex operator""_rr(unsigned long long value)
{
    return Utils::RangeIndex(static_cast<size_t>(value), true);
}
